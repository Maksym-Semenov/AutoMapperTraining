...
namespace AutoMapperTraining.Controllers
{
    public class BranchesController : Controller
    {
        ...
        public BranchesController(AutoMapperContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Index()
        {
              return _context.Branches != null ? 
                          ...
                          Problem("Entity set 'AutoMapperContext.Branches'  is null.");
        }
        ...
        public async Task<IActionResult> DeleteConfirmed(int id)
        {
            ...
            {
                return Problem("Entity set 'AutoMapperContext.Branches'  is null.");
            }
            var branch = await _context.Branches.FindAsync(id);
            if (branch != null)
            {
